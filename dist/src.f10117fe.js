...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      var handelers = _this.events[eventName];

      if (!handelers || !handelers.length) {
        return;
      }

      handelers.forEach(function (callback) {
        return callback();
      });
    };
  }
...
function () {
  function User(attrs) {
    // Hardcoded instance of Eventing Class
  ...
  Object.defineProperty(User.prototype, "on", {
    get: function get() {
      // Gets a refference of the .on() method in the Eventing class.
...
user.save();
},{"./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v16.6.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "46189" + '/');
...
},{}]},{},["../../../../.nvm/versions/node/v16.6.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
